    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_price_list', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.listaprecios')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='cliente',
            name='payment_terms',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.terminopago'),
        ),
        migrations.AddField(
            model_name='cliente',
            name='tags',
            field=models.ManyToManyField(blank=True, to='crm.etiquetacliente'),
        ),
        migrations.CreateModel(
            name='ArchivoCliente',
            fields=[
